...
class Fenster(QWidget):
    ...
    def initWindow(self):
        ...
        self.ef_fg_tp.setRange(1.0, 100000.0)
        self.ef_fg_tp.setSuffix(" Hz")
        self.ef_fg_tp.setValue(1000.0)
        self.ef_fg_tp.setToolTip("Grenzfrequenz des Durchlassbereichs bei Tiefpässen (1:100000) [Hz]")

        self.ef_fs_tp    = QDoubleSpinBox(self)
        self.ef_fs_tp.setRange(1.0, 100000.0)
        self.ef_fs_tp.setSuffix(" Hz")
        self.ef_fs_tp.setValue(4000.0)
        self.ef_fs_tp.setToolTip("Grenzfrequenz des Sperrbereichs bei Tiefpässen (1:100000) [Hz]")
        # Hochpass
        self.ef_fg_hp    = QDoubleSpinBox(self)
        self.ef_fg_hp.setRange(1.0, 100000.0)
        self.ef_fg_hp.setSuffix(" Hz")
        self.ef_fg_hp.setValue(4000.0)
        self.ef_fg_hp.setToolTip("Grenzfrequenz des Durchlassbereichs bei Hochpässen (1:100000) [Hz]")

        self.ef_fs_hp    = QDoubleSpinBox(self)
        self.ef_fs_hp.setRange(1.0, 100000.0)
        self.ef_fs_hp.setSuffix(" Hz")
        self.ef_fs_hp.setValue(1000.0)
        self.ef_fs_hp.setToolTip("Grenzfrequenz des Sperrbereichs bei Hochpässen (1:100000) [Hz]")
        #Bandpass
        self.ef_fM_bp    = QDoubleSpinBox(self)
        self.ef_fM_bp.setRange(1.0, 100000.0)
        self.ef_fM_bp.setSuffix(" Hz")
        self.ef_fM_bp.setValue(1000.0)
        self.ef_fM_bp.setToolTip("Mittenfrequenz eines symetrischen Bandpasses (1:100000) [Hz]")
        self.ef_dfd_bp   = QDoubleSpinBox(self)
        self.ef_dfd_bp.setRange(1.0, 100000.0)
        self.ef_dfd_bp.setSuffix(" Hz")
        self.ef_dfd_bp.setValue(1000.0)
        self.ef_dfd_bp.setToolTip("Bandbreite des Durchlassbereichs eines Bandpasses (1:100000) [Hz]")
        self.ef_dfs_bp   = QDoubleSpinBox(self)
        self.ef_dfs_bp.setRange(1.0, 100000.0)
        self.ef_dfs_bp.setSuffix(" Hz")
        self.ef_dfs_bp.setValue(4000.0)
        self.ef_dfs_bp.setToolTip("Bandbreite des Sperrbereichs eines Bandpasses (1:100000) [Hz]")
        # Filtergrad
